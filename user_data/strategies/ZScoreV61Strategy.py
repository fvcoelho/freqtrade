"""
ZScoreV61Strategy — Always-On Queue with Regime Scoring (Vectorized)
=====================================================================
...
CONFIG_PATH = Path(__file__).parent / "v61_config.json"


class ZScoreV61Strategy(IStrategy):
    ...
    def confirm_trade_entry(self, pair: str, order_type: str, amount: float,
        ...
        """Queue gate: LONG ONLY — shorts blocked."""
        if side == "short":
            return False
