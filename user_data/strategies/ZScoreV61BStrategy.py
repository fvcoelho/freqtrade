"""
ZScoreV61BStrategy — Always-On Queue with Regime Scoring (Vectorized)
=====================================================================
...
CONFIG_PATH = Path(__file__).parent / "v61b_config.json"


class ZScoreV61BStrategy(IStrategy):
    ...
    def confirm_trade_entry(self, pair: str, order_type: str, amount: float,
        ...
        """Queue gate: configurable long/short per pair."""
