...
Freqtrade's resolver does a text search for 'class MicroRevertStrategy'
...
from micro_revert.strategy import MicroRevertStrategy as _Base


class MicroRevertStrategy(_Base):
    pass
