"""
Persistent state for V53 strategy — survives backtest cycles.
...
Usage:
    state = StrategyState("v53_backtest_20260401")
...
class StrategyState:
    ...
    def _load(self):
        try:
            ...
            logger.warning(f"V53 STATE: failed to load {self._path}: {e}")
    ...
    def save(self):
        ...
        try:
            ...
            logger.warning(f"V53 STATE: failed to save: {e}")
