"""
BetaV59Strategy — Always-On Queue with Regime Scoring (Vectorized)
=====================================================================
...
from beta_v59 import btc_trend, volume, basket, config as cfg_loader, dca, entry_queue
from beta_v59.stake import DynamicStake
from beta_v59.state import StrategyState

logger = logging.getLogger(__name__)

CONFIG_PATH = Path(__file__).parent.parent / "beta_v59_config.json"


class BetaV59Strategy(IStrategy):
    ...
    def __init__(self, *args, **kwargs):
        ...
        entry_queue.reset()
        logger.info("BetaV59 loaded — %d pairs, always-on queue, min_score=%.2f",
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # changes when a new candle arrives. id(dataframe) was per-pair and broke accumulation.
