"""
Persistent state for V56 strategy — survives backtest cycles.
...
Usage:
    state = StrategyState("v56_backtest_20260401")
...
class StrategyState:
    ...
    def _load(self):
        try:
            ...
            logger.warning(f"V56 STATE: failed to load {self._path}: {e}")
    ...
    def save(self):
        ...
        try:
            ...
            logger.warning(f"V56 STATE: failed to save: {e}")
