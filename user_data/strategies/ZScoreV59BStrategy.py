"""
ZScoreV59BStrategy — Always-On Queue with Regime Scoring (Vectorized)
=====================================================================
...
CONFIG_PATH = Path(__file__).parent / "v59b_config.json"


class ZScoreV59BStrategy(IStrategy):
    ...
    def confirm_trade_entry(self, pair: str, order_type: str, amount: float,
        ...
        """Queue gate: SHORT ONLY — longs blocked."""
        if side == "long":
            return False
