"""
Z-Score Pairs Trading V13 — V11 + DCA Recovery
15m scalper with regime filter, BTC trend filter, balanced group entries,
and DCA position adjustment to average down on losing trades.

From V11: all indicators, filters, entries, exits
New: DCA after 1h if trade is down > 1.5%, with BTC chaos guard
"""
...
class ZScorePairsTradingV13b(ZScorePairsTradingBase):
    ...
    # Time stop: 5h instead of V11's 6h
    ...
    regime_corr_min = DecimalParameter(0.2, 0.7, default=0.6, decimals=1, space="buy", optimize=True)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if is_a:
            dataframe.loc[vol & regime & spread_low & safe_long, ["enter_long", "enter_tag"]] = (1, "v13b_long_a")
            dataframe.loc[vol & regime & spread_high & safe_short, ["enter_short", "enter_tag"]] = (1, "v13b_short_a")
        elif is_b:
            dataframe.loc[vol & regime & spread_low & safe_short, ["enter_short", "enter_tag"]] = (1, "v13b_short_b")
            dataframe.loc[vol & regime & spread_high & safe_long, ["enter_long", "enter_tag"]] = (1, "v13b_long_b")

        return dataframe

    # =========================================================================
    # EXIT — ROI handles profits, 5h time stop handles losers
    # =========================================================================
